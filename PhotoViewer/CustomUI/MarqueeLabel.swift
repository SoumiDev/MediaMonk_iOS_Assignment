...
class MarqueeLabel: UILabel,CAAnimationDelegate {
    ...
    private func setLabelWith(){
        ...
        if !(self.innerText?.isEmpty)! {
            ...
            let attr:NSAttributedString = NSAttributedString.init(string: self.innerText!, attributes: [NSAttributedString.Key.font:UIFont.systemFont(ofSize: self.innerSize!)])
